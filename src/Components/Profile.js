...
function Profile() {
  ...
  let input = localStorage.getItem("notes")
  ...
  const getWeatherInfo = () => {
    fetch(
      "https://api.weatherapi.com/v1/current.json?key=54c1526b0211468e812153812230610&q=Ghaziabad"
    )
      .then((res) => res.json())
      .then((data) => {
        setWeatherInfo(data);
  ...
  const getNewsInfo = () => {
    ...
    fetch(
      "https://newsapi.org/v2/top-headlines?country=us&-news&apiKey=5a6c4ec765144d3fac8262d016802dcb"
    )
      .then((res) => res.json())
      .then((data) => {
    ...
    <div className="profile-page">
      <div className="part-left">
        <div className="upper-area">
                ...
                <div className="temperature">
                  ...
                  <div className="pressure">
                    ...
                    <div className="pressure-content">
                      {weatherInfo &&
                        `${weatherInfo.current.pressure_mb}mbar Pressure`}
                    </div>
                  </div>
                </div>
                <div className="vertical-line"></div>
                <div className="wind-humidity">
                  <div className="air-info">
                    ...
                    <div className="air-content">
                      {weatherInfo &&
                        `${weatherInfo.current.wind_kph} km/h Wind`}
                    </div>
                  </div>
                  <div className="humid-info">
                    ...
                    <div className="humid-content">
                      {weatherInfo &&
                        `${weatherInfo.current.humidity}% Humidity`}
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="section-two">
            <div className="text-title">All notes</div>
            <textarea
              className="text-area"
              value={notes}
      ...
      <div className="part-right">
        <div className="news-part">
          <div className="upwards">
            <img
              src={
                newsInfo
                  ? newsInfo[index].urlToImage
                  : "https://placehold.jp/eeeeee/cccccc/350x150.png?text=No%20Image"
              }
              alt="default"
              style={{ width: "100%", height: "100%" }}
            />
          ...
          <div className="downwards">
            {newsInfo ? (
              newsInfo[index].content !== null ? (
                newsInfo[index].content
              ) : (
                <img
                  src="https://placehold.jp/ffffff/A9A9A9/150x150.png?text=No%20Content"
                  alt=""
                />
              )
            ) : (
        ...
        <div className="browse-btn">
          <button className="graze-btn" onClick={() => navigate("/browse")}>
            Browse
          </button>
        </div>
      </div>
